	...
	return (
		<div className="flex-[2] min-w-0 bg-[#09090b] border border-white/5 rounded-2xl flex flex-col shadow-xl h-full overflow-hidden">
			...
			<div className="flex-shrink-0 p-4 pt-3 border-t border-white/5 bg-[#09090b]">
				...
				<div className="mt-4 pt-2 border-t border-white/5 flex flex-col items-center gap-1 opacity-40 hover:opacity-100 transition-opacity cursor-default">
					<span className="text-[9px] uppercase tracking-widest font-medium text-slate-500">
						Built by
					</span>
					<button
						type="button"
						onClick={() => window.electronAPI?.openExternalUrl("https://www.devluxestudio.site/")}
						className="text-[10px] font-bold text-slate-400 hover:text-[#34B27B] transition-colors"
					>
						Devluxe Studio
					</button>
				</div>
